...
from IsonAI.ultralytics.yolo.utils import LOGGER, checks, is_online
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from IsonAI.ultralytics.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    from IsonAI.ultralytics.yolo.utils import SETTINGS  # scoped for circular import
