...
from IsonAI.ultralytics import __version__

# # Constants
FILE = Path(__file__).resolve()
ROOT = FILE.parents[2]  # YOLO
# ROOT = Path('/app/service_detect/IsonAI/ultralytics')
DEFAULT_CFG_PATH = ROOT / 'yolo/cfg/default.yaml'
# DEFAULT_CFG_PATH = '/app/service_detect/IsonAI/ultralytics/yolo/cfg/default.yaml'
