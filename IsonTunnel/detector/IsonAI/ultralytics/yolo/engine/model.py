...
from IsonAI.ultralytics import yolo  # noqa
from IsonAI.ultralytics.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                                  guess_model_task, nn)
from IsonAI.ultralytics.yolo.cfg import get_cfg
from IsonAI.ultralytics.yolo.engine.exporter import Exporter
from IsonAI.ultralytics.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, ONLINE, RANK, ROOT,
                                    callbacks, is_git_dir, is_pip_package, yaml_load)
from IsonAI.ultralytics.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from IsonAI.ultralytics.yolo.utils.downloads import GITHUB_ASSET_STEMS
from IsonAI.ultralytics.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    def track(self, source=None, stream=False, **kwargs):
        from IsonAI.ultralytics.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from IsonAI.ultralytics.yolo.utils.benchmarks import benchmark
